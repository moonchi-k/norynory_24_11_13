...
//   const url =
//     "https://apis.data.go.kr/1741000/pfc2/pfc/getPfctInfo2?serviceKey=IFr6Kev%2BzDhhRrHCFEY4i0AXxL5VQ1WwlyFKA%2F3yzoGRdxi0nJ6WFAMiL6l7N5BbOlYSn0%2FF0YxMHxes5WGlnw%3D%3D&pageIndex=1&recordCountPerPage=2000&pfctNm=%EA%B3%B5%EC%9B%90";
//   return fetch(url)
//     .then((response) => response.json()) // 응답을 JSON 형식으로 파싱
//     .then((data) => {
//       // data.items 배열을 가져옵니다.
